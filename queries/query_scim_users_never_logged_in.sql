...
WHERE a.SUSPENDED_TIME IS NULL  -- Not suspended
    ...
    AND u.CREATED_ON >= DATEADD(day, -1, DATE_TRUNC('day', '2025-11-21'::DATE))  -- Start of 5 days ago
    AND u.CREATED_ON < DATEADD(day, 0, DATE_TRUNC('day', '2025-11-21'::DATE))  -- Start of 4 days ago
ORDER BY a.name
